...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hexaflexagon Atelier" },
      { name: "description", content: "Compose your own trihexaflexagon from three images and print a fold-ready template." },
      { name: "author", content: "Hexaflexagon Atelier" },
